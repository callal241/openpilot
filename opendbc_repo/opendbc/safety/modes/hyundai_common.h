...
extern bool hyundai_max_torque_511;
bool hyundai_max_torque_511 = false;
...
void hyundai_common_init(uint16_t param) {
  ...
  const uint16_t HYUNDAI_PARAM_MAX_TORQUE_511 = 1024;
  ...
  hyundai_max_torque_511 = GET_FLAG(param, HYUNDAI_PARAM_MAX_TORQUE_511);
